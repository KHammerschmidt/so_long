...
/* Function to check if input map has the correct size and characters. If not
an error message is displayed, -1 returned and the main function calls
ft_close() to free all memory area. */
